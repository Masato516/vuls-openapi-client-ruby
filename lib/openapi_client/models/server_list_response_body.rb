...
module OpenapiClient
  class ServerListResponseBody
    ...
    attr_accessor :success_scan_count
    ...
    def self.attribute_map
      {
        ...
        :'success_scan_count' => :'successScanCount',
        :'tags' => :'tags',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ServerListResponseBody` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ServerListResponseBody`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'success_scan_count')
        self.success_scan_count = attributes[:'success_scan_count']
      end
    ...
    def list_invalid_properties
      ...
      if @success_scan_count.nil?
        invalid_properties.push('invalid value for "success_scan_count", success_scan_count cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @success_scan_count.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          success_scan_count == o.success_scan_count &&
          tags == o.tags &&
    ...
    def hash
      [created_at, default_user_id, default_user_name, host_uuid, id, last_scanned_at, last_uploaded_at, need_kernel_restart, os_family, os_version, platform_instance_id, platform_name, server_ipv4, server_name, server_uuid, serverrole_id, serverrole_name, success_scan_count, tags, updated_at].hash
    end
